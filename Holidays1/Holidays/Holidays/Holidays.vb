...
Public Class Holidays
    ...
    Private Sub cmdCount_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCount.Click
        ...
        Dim HolidayData() As String = File.ReadAllLines(". . . .")
        For i = 0 To UBound(HolidayData)
            ...
            If Trim(Mid(". . . ."(i), 51, 50)) = ". . . ." And Not txtHolidayName.Text = "" Then CountGot = CountGot + 1
            If Trim(Mid(". . . ."(i), 101, 50)) = ". . . ." And Not txtLocation.Text = "" Then CountGot = CountGot + 1
            If Trim(Mid(". . . ."(i), 151, 50)) = ". . . ." And Not txtHolidayType.Text = "" Then CountGot = CountGot + 1 'Counting how many attributes follow the search
            If Trim(Mid(". . . ."(i), 201, 50)) = ". . . ." And Not txtRating.Text = "" Then CountGot = CountGot + 1
